...
class AbstractFactory(ABC):
   @abstractmethod
   def getObjectPao(self,type):
      pass

   @abstractmethod
   def getObjectProteina(self,type):
      pass

#Factory
class ObjectFactoryPao(AbstractFactory):
   def getObjectPao(type):
      if type == "1":
         return PaoBranco()
      elif type == "2":
         return PaoQueijoErvasItalianas()
      elif type == "3":
         return PaoCenteio()
      elif type == "4":
         return PaoTrigo()
   ...
   def getObjectProteina(self):
      pass


class ObjectFactoryProteina(AbstractFactory):
   def getObjectProteina(type,pao):
      if type == "1":
         return Presunto(pao)
      elif type == "2":
         return Frango(pao)
...
if __name__ == '__main__':
   ...
   while(1):
       ...
       pao = ObjectFactoryPao.getObjectPao(opcao1)

       print("1 - Sanduíche normal")
       print("2 - Sanduíche vegetariano (Veggie)")

       tipo = str(input('Qual o tipo de sanduíche você deseja?: '))
       ...
       if tipo == '1':
          while True:
             ...
             proteina = ObjectFactoryProteina.getObjectProteina(opcao2,pao)
             if opcao2 == "1" or opcao2 == "2" or opcao2 == "3":
                break
          
       elif tipo == '2':
          proteina = ObjectFactoryProteina.getObjectProteina("4",pao)
